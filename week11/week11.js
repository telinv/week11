...
function makeTwo() {
	paragraph2.innerHTML = 'Привет, Мир!';
}
...
//Подсказка: Используйте метод для изменения текстового содержимого элемента (innerHTML/innerText/textContent)
const paragraph3 = document.querySelector('#practicum3'); 
function makeThree() {
	paragraph3.textContent = 'Заголовок изменен!';
}
...
const paragraph4 = document.querySelector('#practicum4');
function makeFour() {
...
const paragraph6 = document.getElementById('practicum6');
function makeSix() {
...
const paragraph7 = document.querySelector('#practicum7');
function makeSeven() {
	paragraph7.href = 'https://www.google.com';
	paragraph7.textContent = 'Ссылка на Google';
}
...
const paragraph8 = document.getElementById('practicum8');
function makeEight() {
	const newElementFor8 = document.createElement('li');
	newElementFor8.innerHTML = 'Новый элемент';
	paragraph8.append(newElementFor8);
	//Найдите элемент x
...
//Подсказка: Используйте метод createElement(), который используется для динамического изменения и взаимодействия с элементами веб-страницы, и метод append(item), который добавляет элемент в конец списка. Новый элемент становится последним элементом списка.
const paragraph9 = document.getElementById('practicum9');
function makeNine() {
	const newElementFor9 = document.createElement('option');
	newElementFor9.innerHTML = 'Новый вариант';
	paragraph9.append(newElementFor9);
	//Найдите элемент
...
function makeTwelve() {
	const paragraph12 = document.querySelector('#practicum12');
...
function makeTwenty() {
	...
	const addPToBeginning = document.createElement('p');
	addPToBeginning.textContent = 'Добавлено в начало';
	paragraph20.prepend(addPToBeginning );
	//Ваш код
}
...
function makeTwentyOne() {
	...
	const addPToEnd = document.createElement('p');
	addPToEnd.textContent = 'Добавлено в конец';
	paragraph21.append(addPToEnd);
	//Ваш код
}
...
function makeTwentyTwo() {
	...
	const findSrc= paragraph22.hasAttribute('scr');
	result22.textContent = 'Атрибут "src" присутствует: '+ findSrc;
...
function makeTwentyFive() {
  ...
  infoOutput.textContent = 'Добавленный атрибут: ' + infoOutput;
	//1 шаг: Найдите элемент
...
function makeTwentySeven() {
	...
	const findHidhlight = paragraph27.classList.contains('highlight');
	const result = document.getElementById('result');
	result.textContent = 'содержит ли данный элемент класс `highlight?: '+ findHidhlight;
...
function handleClick() {
	const paragraph28 = document.getElementById('button28');
...
const  meaningWasChanged = document.getElementById('input29');
function handleChange() {
	const paragraph29 = document.getElementById('input29');
	console.log('Значение изменено');
}
meaningWasChanged.addEventListener("change", handleChange);
//Ваш код
...
//Подсказка: Используйте метод addEventListener для добавления обработчика события. Чтобы проверить работу слушателя, нужно напечатать один символ и более в поле ввода и убрать фокус с инпута, кликнув на любое место страницы.
const cursorWasHovered = document.getElementById('div30');
function handleMouseOver() {
	const paragraph30 = document.getElementById('div30');
	console.log('Курсор наведен на элемент');
}
cursorWasHovered.addEventListener("mouseover", handleMouseOver);
//Ваш код
